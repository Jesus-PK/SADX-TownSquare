...
{
    MDL_BasicChest = LoadBasicModel("TownSquare_BasicChest");
    MDL_BCDebris01 = LoadBasicModel("TownSquare_BCDebris01");
    MDL_BCDebris02 = LoadBasicModel("TownSquare_BCDebris02");
    MDL_BCDebris03 = LoadBasicModel("TownSquare_BCDebris03");
    MDL_Number5 = LoadBasicModel("TownSquare_Number5");
