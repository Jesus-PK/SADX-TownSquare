...
void LOAD_LifeChest()
{
    MDL_LifeChest = LoadBasicModel("TownSquare_LifeChest");
    MDL_LCDebris01 = LoadBasicModel("TownSquare_LCDebris01");
    MDL_LCDebris02 = LoadBasicModel("TownSquare_LCDebris02");
    MDL_LCDebris03 = LoadBasicModel("TownSquare_LCDebris03");
    MDL_LifeStatue = LoadBasicModel("TownSquare_LifeStatue");
    ANIM_LifeChest = LoadObjectAnim("TownSquare_LifeChest");
