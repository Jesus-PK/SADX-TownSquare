...
void LOAD_Dragons()
{
    ...
    MDL_Isaak = LoadChunkModel("TownSquare_Isaak");
    MDL_Lyle = LoadChunkModel("TownSquare_Lyle");
    MDL_Jed = LoadChunkModel("TownSquare_Jed");
    MDL_Bruno = LoadChunkModel("TownSquare_Bruno");
    MDL_Cleetus = LoadChunkModel("TownSquare_Cleetus");

    ANIM_Spyro = LoadObjectAnim("TownSquare_SpyroLEDGE");
    ANIM_Isaak = LoadObjectAnim("TownSquare_Isaak");
    ANIM_Lyle = LoadObjectAnim("TownSquare_Lyle");
    ANIM_Jed = LoadObjectAnim("TownSquare_Jed");
    ANIM_Bruno = LoadObjectAnim("TownSquare_Bruno");
    ANIM_Cleetus = LoadObjectAnim("TownSquare_Cleetus");
}