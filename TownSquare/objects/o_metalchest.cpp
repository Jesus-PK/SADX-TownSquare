...
{
    MDL_MetalChest = LoadBasicModel("TownSquare_MetalChest");
    MDL_MCDebris01 = LoadBasicModel("TownSquare_MCDebris01");
    MDL_MCDebris02 = LoadBasicModel("TownSquare_MCDebris02");
    MDL_MCDebris03 = LoadBasicModel("TownSquare_MCDebris03");
    MDL_Number10 = LoadBasicModel("TownSquare_Number10");
