...
// Since it's not possible yet to individually edit already existing Trial Menu entries with HelperFunctions, I edited the whole array without them. This only work for the trial menu and it won't apply for adventure mode, as a failsafe I changed startpos of the level to directly spawn you into the act change trigger until Act 3.
